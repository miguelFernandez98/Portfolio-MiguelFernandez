export const SkeletonLoader = () => {
  return (
    <section className="p-6 rounded-xl border border-white/10">
      ...
      <div className="h-4 bg-gray-700 rounded mb-3 animate-pulse w-full"></div>
      <div className="h-4 bg-gray-700 rounded mb-4 animate-pulse w-2/3"></div>
      ...
      <div className="w-full flex flex-row justify-between items-center">
        ...
        <div className="h-4 w-auto animate-pulse text-white/80">Coming soon...</div>
      </div>
    </section>
  );
};
